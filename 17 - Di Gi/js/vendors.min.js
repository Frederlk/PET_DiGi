 ...
 * MIT license
 */
function(e,t){"function"==typeof define&&define.amd?define(t):"object"==typeof module&&module.exports?module.exports=t():e.Colcade=t()}(window,(function(){function e(e,t){if((e=o(e))&&e.colcadeGUID){var a=i[e.colcadeGUID];return a.option(t),a}this.element=e,this.options={},this.option(t),this.create()}var t=e.prototype;t.option=function(e){this.options=function(e,t){for(var a in t)e[a]=t[a];return e}(this.options,e)};var a=0,i={};function s(t){var a=t.getAttribute("data-colcade").split(","),i={};a.forEach((function(e){var t=e.split(":"),a=t[0].trim(),s=t[1].trim();i[a]=s})),new e(t,i)}function r(e){var t=[];if(Array.isArray(e))t=e;else if(e&&"number"==typeof e.length)for(var a=0;a<e.length;a++)t.push(e[a]);else t.push(e);return t}function n(e,t){return r((t=t||document).querySelectorAll(e))}function o(e){return"string"==typeof e&&(e=document.querySelector(e)),e}return t.create=function(){this.errorCheck();var e=this.guid=++a;this.element.colcadeGUID=e,i[e]=this,this.reload(),this._windowResizeHandler=this.onWindowResize.bind(this),this._loadHandler=this.onLoad.bind(this),window.addEventListener("resize",this._windowResizeHandler),this.element.addEventListener("load",this._loadHandler,!0)},t.errorCheck=function(){var e=[];if(this.element||e.push("Bad element: "+this.element),this.options.columns||e.push("columns option required: "+this.options.columns),this.options.items||e.push("items option required: "+this.options.items),e.length)throw new Error("[Colcade error] "+e.join(". "))},t.reload=function(){this.updateColumns(),this.updateItems(),this.layout()},t.updateColumns=function(){this.columns=n(this.options.columns,this.element)},t.updateItems=function(){this.items=n(this.options.items,this.element)},t.getActiveColumns=function(){return this.columns.filter((function(e){return"none"!=getComputedStyle(e).display}))},t.layout=function(){this.activeColumns=this.getActiveColumns(),this._layout()},t._layout=function(){this.columnHeights=this.activeColumns.map((function(){return 0})),this.layoutItems(this.items)},t.layoutItems=function(e){e.forEach(this.layoutItem,this)},t.layoutItem=function(e){var t=Math.min.apply(Math,this.columnHeights),a=this.columnHeights.indexOf(t);this.activeColumns[a].appendChild(e),this.columnHeights[a]+=e.offsetHeight||1},t.append=function(e){var t=this.getQueryItems(e);this.items=this.items.concat(t),this.layoutItems(t)},t.prepend=function(e){var t=this.getQueryItems(e);this.items=t.concat(this.items),this._layout()},t.getQueryItems=function(e){e=r(e);var t=document.createDocumentFragment();return e.forEach((function(e){t.appendChild(e)})),n(this.options.items,t)},t.measureColumnHeight=function(e){var t=this.element.getBoundingClientRect();this.activeColumns.forEach((function(a,i){if(!e||a.contains(e)){var s=a.lastElementChild.getBoundingClientRect();this.columnHeights[i]=s.bottom-t.top}}),this)},t.onWindowResize=function(){clearTimeout(this.resizeTimeout),this.resizeTimeout=setTimeout(function(){this.onDebouncedResize()}.bind(this),100)},t.onDebouncedResize=function(){var e=this.getActiveColumns(),t=e.length==this.activeColumns.length,a=!0;this.activeColumns.forEach((function(t,i){a=a&&t==e[i]})),t&&a||(this.activeColumns=e,this._layout())},t.onLoad=function(e){this.measureColumnHeight(e.target)},t.destroy=function(){this.items.forEach((function(e){this.element.appendChild(e)}),this),window.removeEventListener("resize",this._windowResizeHandler),this.element.removeEventListener("load",this._loadHandler,!0),delete this.element.colcadeGUID,delete i[this.guid]},function(e){if("complete"==document.readyState)return void e();document.addEventListener("DOMContentLoaded",e)}((function(){n("[data-colcade]").forEach(s)})),e.data=function(e){var t=(e=o(e))&&e.colcadeGUID;return t&&i[t]},e.makeJQueryPlugin=function(t){function a(e,a,i){var s;return e.each((function(e,r){var n=t.data(r,"colcade");if(n){var o=n[a].apply(n,i);s=void 0===s?o:s}})),void 0!==s?s:e}function i(a,i){a.each((function(a,s){var r=t.data(s,"colcade");r?(r.option(i),r.layout()):(r=new e(s,i),t.data(s,"colcade",r))}))}(t=t||window.jQuery)&&(t.fn.colcade=function(e){if("string"==typeof e){var t=Array.prototype.slice.call(arguments,1);return a(this,e,t)}return i(this,e),this})},e.makeJQueryPlugin(),e}));