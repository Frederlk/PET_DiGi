...
*/
var grid = document.querySelector('.news__masonry');
var colc = new Colcade(grid, {
   columns: '.news__grid-column',
   items: '.news__grid-item'
});
...
let slider_home = new Swiper('.slider-home__content', {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-home__navigation-next',
		prevEl: '.slider-home__navigation-prev',
	},
